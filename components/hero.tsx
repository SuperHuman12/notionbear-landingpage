      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-18 md:pb-20">
          <div className="text-center">
            <h1
              className="sm:text-5xl md:text-5xl font-extrabold leading-tight tracking-loose mb-4 aos-init aos-animate"
              data-aos="zoom-y-out"
            >
              ...
              <span className="flex gap-4 justify-center">
                ...
                <svg
                  ...
                  className="object-contain m-auto ml-0 mr-0 items-center w-16 h-16 sm:w-10 sm:h-10 md:w-30 md:h-30"
                >
                  <path
