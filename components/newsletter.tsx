    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
        <div className="pb-12 md:pb-20">
          ...
          {/* CTA box */}
          <div className="relative bg-gray-900 rounded-full py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden rounded-2xl" 
          >
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <form className="w-full lg:w-auto">
                  ...
                  <Link href="app.BoringSites.com" className="btn bg-orange-600 hover:bg-orange-700 shadow" >Create</Link>
                  </div>
                  {/* Success message */}
