        ...
        <div role="list" className="project_type-list w-dyn-items grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div role="listitem" className="project_type-item w-dyn-item bg-white shadow-lg p-6 rounded-lg">
                <div className="grid gap-4 items-center">
                    <Image loading="lazy" height="60" alt="Platform migrations" src="https://assets-global.website-files.com/6320a2f3bd0b234991397e96/65316fc6b33cce40a33c2b1b_Migration.svg" className="project_type-image mr-4" style={{ filter: 'hue-rotate(161deg)' }} />
                    <div>
            ...
            <div role="listitem" className="project_type-item w-dyn-item bg-white shadow-lg p-6 rounded-lg">
                <div className="grid gap-4 items-center">
                    <Image loading="lazy" height="60" alt="Custom code &amp; integrations" src="https://assets-global.website-files.com/6320a2f3bd0b234991397e96/65316fb84aabe974ccc5e90a_Plugins.svg" className="project_type-image mr-4" style={{ filter: 'hue-rotate(161deg)' }} />
                    <div>
            ...
            <div role="listitem" className="project_type-item w-dyn-item bg-white shadow-lg p-6 rounded-lg">
                <div className="grid gap-4 items-center">
                    <Image loading="lazy" height="60" alt="Rebrands &amp; redesigns" src="https://assets-global.website-files.com/6320a2f3bd0b234991397e96/65316f5a0c978936919bd6fe_SiteRefresh.svg" className="project_type-image mr-4" style={{ filter: 'hue-rotate(161deg)' }} />
                    <div>
