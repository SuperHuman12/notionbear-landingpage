      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-18 md:pb-20">
          ...
          <div className="max-w-4xl py-10 mx-auto lg:py-12">
            ...
            <div className="max-w-screen-xl px-4 mx-auto mt-10 sm:px-6 md:mt-16 lg:mt-20"><div className="text-center"><h1 className="text-3xl font-extrabold leading-8 tracking-tight text-gray-900 sm:leading-10 sm:text-5xl md:text-5xl">
            Turn 
            
            <span className="text-3xl md:text-5xl sm:text-5xl relative"><span className="inline-flex items-center relative sm:bottom-0 bottom-[-1px] justify-center ml-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="12 0.19 487.619 510.941" className="w-6 h-6 mr-0.5 sm:w-9 sm:h-9"><path d="M96.085 91.118c15.81 12.845 21.741 11.865 51.43 9.884l279.888-16.806c5.936 0 1-5.922-.98-6.906L379.94 43.686c-8.907-6.915-20.773-14.834-43.516-12.853L65.408 50.6c-9.884.98-11.858 5.922-7.922 9.883zm16.804 65.228v294.491c0 15.827 7.909 21.748 25.71 20.769l307.597-17.799c17.81-.979 19.794-11.865 19.794-24.722V136.57c0-12.836-4.938-19.758-15.84-18.77l-321.442 18.77c-11.863.997-15.82 6.931-15.82 19.776zm303.659 15.797c1.972 8.903 0 17.798-8.92 18.799l-14.82 2.953v217.412c-12.868 6.916-24.734 10.87-34.622 10.87-15.831 0-19.796-4.945-31.654-19.76l-96.944-152.19v147.248l30.677 6.922s0 17.78-24.75 17.78l-68.23 3.958c-1.982-3.958 0-13.832 6.921-15.81l17.805-4.935V210.7l-24.721-1.981c-1.983-8.903 2.955-21.74 16.812-22.736l73.195-4.934L358.186 335.22V198.836l-25.723-2.952c-1.974-10.884 5.927-18.787 15.819-19.767zM42.653 23.919l281.9-20.76c34.618-2.969 43.525-.98 65.283 14.825l89.986 63.247c14.848 10.876 19.797 13.837 19.797 25.693v346.883c0 21.74-7.92 34.597-35.608 36.564L136.64 510.14c-20.785.991-30.677-1.971-41.562-15.815l-66.267-85.978C16.938 392.52 12 380.68 12 366.828V58.495c0-17.778 7.922-32.608 30.653-34.576z" fill-rule="evenodd"></path></svg></span> Notion into a</span> <br className="block"/>
             professional 
             <span className="text-3xl sm:text-5xl md:text-5xl gradient-text-accent">Help Center</span></h1> <p className="max-w-md mx-auto mt-3 -mb-3 text-base text-gray-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
            HelpKit is the perfect tool for creating your help center powered
            by Notion. You write your help articles in Notion and HelpKit
            takes care of the rest. It's as simple as that.
          </p> <div className="flex flex-col-reverse justify-center w-full mt-10 -mb-8 sm:flex-row"><div className="mt-3 sm:mt-0"><a href="/signup" className="
                  inline-flex
                  items-center
                  justify-center
                  w-full
                  ...
                  gradient-bg-accent
                  sm:w-auto
                "><strong className="mr-1">Create your Help Center with Notion →</strong></a> <p className="mt-3 text-sm text-gray-700"><strong> Free</strong> 7 day trial. No credit card required.
              </p></div></div></div></div>


              <h1 className="md:text-5xl font-bold tracking-tight text-gray-900 sm:text-4xl font-extrabold leading-tighter tracking-tighter mb-4 aos-init aos-animate">
                Turn your 
                <span className="flex gap-4 justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="12 0.19 487.619 510.941"
                    className="w-16 h-30 mr-2 sm:w-16 sm:h-16 ml-4 m-auto"
                  >
                    <path
                ...
                into a professional 
                <span className="gradient-text-accent">Blog</span> in minutes.
              </h1>
