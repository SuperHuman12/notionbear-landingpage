...
export default function ResetPassword() {
  return (
    ...
    <div className="text-center">
        <h1 className="md:text-5xl font-bold tracking-tight text-gray-900 sm:text-4xl font-extrabold leading-loose tracking-tighter mb-4 aos-init aos-animate">
            Turn
            <span className="text-3xl md:text-5xl sm:text-5xl relative">
                <span className="inline-flex items-center relative sm:bottom-0 bottom-[-1px] justify-center ml-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="12 0.19 487.619 510.941" className="w-6 h-6 mr-0.5 sm:w-9 sm:h-9">
                        <path
            ...
            <br className="block" />
            professional<span className="text-3xl sm:text-5xl md:text-5xl gradient-text-accent">Blog</span>
        </h1>
        ...
        <div className="flex flex-col-reverse justify-center w-full mt-10 -mb-8 sm:flex-row">
            <div className="mt-3 sm:mt-0">
                <a href="/signup" className="inline-flex items-center justify-center w-full px-6 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out rounded-md shadow gradient-bg-accent sm:w-auto">
