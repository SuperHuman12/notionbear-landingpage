...
export const metadata = {
    ...
    description:
        "Build a company wiki in Notion, with our Notion company wiki maker. Go live in under a minute.  Build your free BoringSites company wiki website in a minute!",
        openGraph: {
            images: [
                {
                    ...
                    width: 1200,
                    height: 630,
                    alt: "Create a company wiki with Notion",
                },
            ],
        },
        twitter: {
  ...
  <div className="max-w-screen-xl px-4 mx-auto sm:px-6 mb-20">
    <div className="text-center">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-gray-900 leading-tighter tracking-tighter mb-4 aos-init aos-animate">
        ...
        <br className="block" />
        collaborative <span className="text-3xl sm:text-4xl md:text-5xl gradient-text-accent mx-4">company wikipedia</span>
      </h1>
      <p className="max-w-md mx-auto mt-3 text-base text-gray-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
        BoringSites is the perfect tool for creating your company wikis powered by Notion. You write your articles in Notion and BoringSites takes care of the rest. It's as simple as that.
      </p>
      <div className="flex flex-col-reverse justify-center w-full mt-10 sm:flex-row">
        <div className="mt-3 sm:mt-0">
          <Link href="/signup" className="inline-flex items-center justify-center w-full px-6 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out rounded-2xl shadow bg-orange-700 sm:w-auto">
            <strong className="mr-1">Create your company wiki with Notion →</strong>
          </Link>
