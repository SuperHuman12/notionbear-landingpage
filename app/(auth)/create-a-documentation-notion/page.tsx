...
export default function PageDetail() {
  ...
  <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-gray-900 leading-tighter tracking-tighter mb-4 aos-init aos-animate">
    ...
    <br className="block" />
    professional <span className="text-3xl sm:text-4xl md:text-5xl gradient-text-accent mx-4">documentation</span>
  </h1>
  <p className="max-w-md mx-auto mt-3 text-base text-gray-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
    BoringSites is the perfect tool for creating your documentations powered by Notion. You write your articles in Notion and BoringSites takes care of the rest. It's as simple as that.
  </p>
