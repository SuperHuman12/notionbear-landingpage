                            ...
                            <div className="max-w-screen-xl px-4 mx-auto sm:px-6 mb-20">
                                <div className="text-center">
                                    <h1 className="md:text-5xl font-bold tracking-tight text-gray-900 sm:text-4xl font-extrabold leading-tighter tracking-tighter mb-4 aos-init aos-animate">
                                        ...
                                        <br className="block" />
                                        professional<span className="text-3xl sm:text-5xl md:text-5xl gradient-text-accent mx-4">documentation</span>
                                    </h1>
                                    <p className="max-w-md mx-auto mt-3 -mb-3 text-base text-gray-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
                                        NotionBear is the perfect tool for creating your documentations powered by notion. You write your articles in Notion and NotionBear takes care of the rest. It's as simple as that.
                                    </p>
