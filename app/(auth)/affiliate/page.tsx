...
refer to NotionBear, without limits. Join
        our affiliate program today and start earning money.
          ...
          <a href="https://notionbear.tolt.io/" target="_blank" className="block mt-8 text-sm text-purple-600 sm:mt-4 opacity-40 hover:opacity-100 m-auto w-fit">Already partner? Open the affiliate dashboard →</a>
