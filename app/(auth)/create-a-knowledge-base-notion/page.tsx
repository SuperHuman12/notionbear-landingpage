...
export const metadata = {
    ...
    description:
        "Build a knowledge base in Notion, with our Notion knowledge base maker. Go live in under a minute.  Build your free BoringSites knowledge base website in a minute!",
        openGraph: {
            images: [
                {
...
export default function PageDetail() {
  ...
  <p className="max-w-md mx-auto mt-3 text-base text-gray-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
    BoringSites is the perfect tool for creating your knowledge bases powered by Notion. You write your articles in Notion and BoringSites takes care of the rest. It's as simple as that.
  </p>
  <div className="flex flex-col-reverse justify-center w-full mt-10 sm:flex-row">
    <div className="mt-3 sm:mt-0">
      <Link href="/signup" className="inline-flex items-center justify-center w-full px-6 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out rounded-2xl shadow bg-orange-700 sm:w-auto">
        <strong className="mr-1">Create your knowledge base with Notion →</strong>
      </Link>
