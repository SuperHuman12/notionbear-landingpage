    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-1 gap-y-8 gap-x-12 lg:grid-cols-2 lg:items-center xl:gap-x-16 mb-12">
                ...
                <div className="relative w-full"><Image src="https://dazzling-cat.netlify.app/write%20on%20notion.png" alt="" className="h-full w-full rounded-2xl object-cover" /></div>
            </div>



            <div className="grid grid-cols-1 gap-y-8 gap-x-12 lg:grid-cols-2 lg:items-center xl:gap-x-16 mb-12">
                <div className="relative w-full"><Image src="https://dazzling-cat.netlify.app/notion%20to%20website.png" alt="" className="h-full w-full rounded-2xl object-cover" /></div>
            ...
            <div className="grid grid-cols-1 gap-y-8 gap-x-12 lg:grid-cols-2 lg:items-center xl:gap-x-16 mb-12">
                ...
                <div className="relative w-full"><Image src="https://dazzling-cat.netlify.app/performancewebsite.png" alt="" className="h-full w-full rounded-2xl object-cover" /></div>
            </div>


            <div className="grid grid-cols-1 gap-y-8 gap-x-12 lg:grid-cols-2 lg:items-center xl:gap-x-16 mb-12">

                <div className="relative w-full"><Image src="https://dazzling-cat.netlify.app/analyticsseo.png" alt="" className="h-full w-full rounded-2xl object-cover" /></div>
            ...
            <div className="grid grid-cols-1 gap-y-8 gap-x-12 lg:grid-cols-2 lg:items-center xl:gap-x-16 mb-12">
                ...
                <div className="relative w-full"><Image src="https://dazzling-cat.netlify.app/integrationsdb.png" alt="" className="h-full w-full rounded-2xl object-cover" /></div>
