        ...
        <div className="pt-32 pb-12 md:pt-18 md:pb-20">
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center aos-init aos-animate mt-6">
              <div><Link className="btn text-dark bg-orange-600 hover:bg-orange-700 w-full mb-4 sm:w-auto sm:mb-0" href="https://app.notionbear.com">Missing Integration? Ask for Help</a></div>
            </div>
