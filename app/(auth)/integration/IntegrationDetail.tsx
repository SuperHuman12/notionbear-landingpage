              ...
              <div className="flex space-y-6" >
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2 items-center" >
                    <Link href="https://app.notionbear.com/integrations/arcade" className="bg-gray-900 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-2xl inline-flex items-center" rel="noopener noreferrer" target="_blank">
                      <span>Install</span>
                    </Link>
                  </div>
                </div>
