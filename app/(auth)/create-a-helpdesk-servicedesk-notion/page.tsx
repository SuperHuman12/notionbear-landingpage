...
export default function PageDetail() {
  ...
  <p className="max-w-md mx-auto mt-3 text-base text-gray-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
    NotionBear is the perfect tool for creating your helpdesks powered by Notion. You write your articles in Notion and NotionBear takes care of the rest. It's as simple as that.
  </p>
