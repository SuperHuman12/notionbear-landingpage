...
import Helpdesk_Type from "@/components/helpdesk_type";
...
export const metadata = {
    ...
    description:
        "Build a help desk in Notion, with our Notion help desk maker. Go live in under a minute.  Build your free BoringSites help desk website in a minute!",
        openGraph: {
            images: [
                {
                    ...
                    width: 1200,
                    height: 630,
                    alt: "Create a help desk with Notion",
                },
            ],
        },
        twitter: {
...
export default function PageDetail() {
  ...
  <p className="max-w-md mx-auto mt-3 text-base text-gray-500 sm:mb-0 sm:text-lg md:mt-5 md:text-lg md:max-w-2xl">
    BoringSites is the perfect tool for creating your helpdesks powered by Notion. You write your articles in Notion and BoringSites takes care of the rest. It's as simple as that.
  </p>
  <div className="flex flex-col-reverse justify-center w-full mt-10 sm:flex-row">
    <div className="mt-3 sm:mt-0">
      <Link href="/signup" className="inline-flex items-center justify-center w-full px-6 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out rounded-2xl shadow bg-orange-700 sm:w-auto">
        <strong className="mr-1">Create your help desk with Notion →</strong>
      </Link>
