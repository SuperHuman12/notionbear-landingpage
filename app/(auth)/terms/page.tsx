                ...
                <main className="notion">
                    ...
                    <p className="text-gray-600 my-2">
                        <span>
                            ...
                            <Link target="_blank" href="https://www.notionbear.com/" className="link"><span>https://www.notionbear.com</span></a>
                            <span>
                    ...
                    <p className="text-gray-600 my-2">
                        <span>
                            <span>We care about data privacy and security. Please review our Privacy Policy:&nbsp;</span><Link target="_blank" href="https://www.notionbear.com/privacy" className="link"><span>https://www.notionbear.com/privacy</span></a>
                    ...
                    <p className="text-gray-600 my-2">
                        <span>
                            ...
                            <Link target="_blank" href="https://ec.europa.eu/consumers/odr" className="link"><span>https://ec.europa.eu/consumers/odr</span></a>
                    ...
                    <p className="text-gray-600 my-2">
                        <span>
                            ...
                            <Link target="_blank" href="https://tolt.io" className="link"><span>tolt.io</span></a>
                    ...
                    <p className="text-gray-600 my-2">
                        <span>
                            ...
                            <Link target="_blank" href="https://termly.io/products/terms-and-conditions-generator/?ftseo" className="link"><span>Termly’s Terms and Conditions Generator</span></a><span>.</span>
                        </span>
                    </p>
                    <div className="blank">&nbsp;</div>
                </main>
